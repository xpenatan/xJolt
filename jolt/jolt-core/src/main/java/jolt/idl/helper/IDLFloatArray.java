...
public class IDLFloatArray extends IDLBase {
    ...
    */
    private static native float internal_native_getValue(long this_addr, int index);
    ...
    */
    private static native void internal_native_setValue(long this_addr, int index, float value);
