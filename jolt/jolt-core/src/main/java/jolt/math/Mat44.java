...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sRotation(Quat inQ) {
        long pointer = internal_native_sRotation((inQ != null ? inQ.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sRotationAxisAngle(Vec3 inAxis, float inAngle) {
        long pointer = internal_native_sRotationAxisAngle((inAxis != null ? inAxis.native_address : 0), inAngle);
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sTranslation(Vec3 inTranslation) {
        long pointer = internal_native_sTranslation((inTranslation != null ? inTranslation.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sRotationTranslation(Quat inRotation, Vec3 inTranslation) {
        long pointer = internal_native_sRotationTranslation((inRotation != null ? inRotation.native_address : 0), (inTranslation != null ? inTranslation.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sInverseRotationTranslation(Quat inRotation, Vec3 inTranslation) {
        long pointer = internal_native_sInverseRotationTranslation((inRotation != null ? inRotation.native_address : 0), (inTranslation != null ? inTranslation.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sScaleVec3(Vec3 inScale) {
        long pointer = internal_native_sScaleVec3((inScale != null ? inScale.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sOuterProduct(Vec3 inV1, Vec3 inV2) {
        long pointer = internal_native_sOuterProduct((inV1 != null ? inV1.native_address : 0), (inV2 != null ? inV2.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sCrossProduct(Vec3 inV) {
        long pointer = internal_native_sCrossProduct((inV != null ? inV.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sQuatLeftMultiply(Quat inQ) {
        long pointer = internal_native_sQuatLeftMultiply((inQ != null ? inQ.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sQuatRightMultiply(Quat inQ) {
        long pointer = internal_native_sQuatRightMultiply((inQ != null ? inQ.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public static Mat44 sLookAt(Vec3 inPos, Vec3 inTarget, Vec3 inUp) {
        long pointer = internal_native_sLookAt((inPos != null ? inPos.native_address : 0), (inTarget != null ? inTarget.native_address : 0), (inUp != null ? inUp.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Vec3 Multiply3x3(Vec3 inV) {
        long pointer = internal_native_Multiply3x3(native_address, (inV != null ? inV.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Vec3 Multiply3x3Transposed(Vec3 inV) {
        long pointer = internal_native_Multiply3x3Transposed(native_address, (inV != null ? inV.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Mat44 Multiply3x3LeftTransposed(Mat44 inM) {
        long pointer = internal_native_Multiply3x3LeftTransposed(native_address, (inM != null ? inM.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Mat44 Multiply3x3RightTransposed(Mat44 inM) {
        long pointer = internal_native_Multiply3x3RightTransposed(native_address, (inM != null ? inM.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Mat44 PreTranslated(Vec3 inTranslation) {
        long pointer = internal_native_PreTranslated(native_address, (inTranslation != null ? inTranslation.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Mat44 PostTranslated(Vec3 inTranslation) {
        long pointer = internal_native_PostTranslated(native_address, (inTranslation != null ? inTranslation.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Mat44 PreScaled(Vec3 inScale) {
        long pointer = internal_native_PreScaled(native_address, (inScale != null ? inScale.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Mat44 PostScaled(Vec3 inScale) {
        long pointer = internal_native_PostScaled(native_address, (inScale != null ? inScale.native_address : 0));
        if (pointer == 0)
            return null;
...
return (jlong)&copy_addr;*/
    ...
    public Mat44 Decompose(Vec3 outScale) {
        long pointer = internal_native_Decompose(native_address, (outScale != null ? outScale.native_address : 0));
        if (pointer == 0)
            return null;
