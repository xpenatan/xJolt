...
public class ArraySkeletonKeyframe extends IDLBase {
    ...
    static public final ArraySkeletonKeyframe T_01 = new ArraySkeletonKeyframe((byte) 1, (char) 1);

    static public final ArraySkeletonKeyframe T_02 = new ArraySkeletonKeyframe((byte) 1, (char) 1);

    static public final ArraySkeletonKeyframe T_03 = new ArraySkeletonKeyframe((byte) 1, (char) 1);
...
*/
     ...
     */
    @Deprecated()
    public ArraySkeletonKeyframe(byte b, char c) {
    }
...
*/
    ...
    public SkeletalAnimationKeyframe at(int inIndex) {
        ...
        if (SkeletalAnimationKeyframe_TEMP_GEN_0 == null)
            SkeletalAnimationKeyframe_TEMP_GEN_0 = new SkeletalAnimationKeyframe((byte) 1, (char) 1);
        SkeletalAnimationKeyframe_TEMP_GEN_0.getNativeData().reset(pointer, false);
