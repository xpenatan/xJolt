...
public class IDLFloatArray extends IDLBase {
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = new jolt.IDLFloatArray(size);
      return jolt.getPointer(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"size"}, script = "var jsObj = new jolt.IDLFloatArray(size);return jolt.getPointer(jsObj);")
    ...
    /*
      [-TEAVM;-NATIVE]
      var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);
      jolt.destroy(jsObj);
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);jolt.destroy(jsObj);")
    ...
    /*
      ...
      jsObj.resize(size);
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "size"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);jsObj.resize(size);")
    ...
    /*
      ...
      jsObj.clear();
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);jsObj.clear();")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);var returnedJSObj = jsObj.getValue(index);return returnedJSObj;")
    private static native float internal_native_getValue(int this_addr, int index);
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "index", "value"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);jsObj.setValue(index, value);")
    private static native void internal_native_setValue(int this_addr, int index, float value);
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);var returnedJSObj = jsObj.getSize();return returnedJSObj;")
    ...
    /*
      ...
      return returnedJSObj;
    */
    @org.teavm.jso.JSBody(params = {"this_addr"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);var returnedJSObj = jsObj.getPointer();return returnedJSObj;")
    ...
    */
    @org.teavm.jso.JSBody(params = {"this_addr", "src_addr", "srcOffset", "destOffset", "length"}, script = "var jsObj = jolt.wrapPointer(this_addr, jolt.IDLFloatArray);jsObj.copy(src_addr, srcOffset, destOffset, length);")
    ...
    public static float native_getValue(long this_addr, int index) {
        return internal_native_getValue((int) this_addr, index);
    }

    public static void native_setValue(long this_addr, int index, float value) {
