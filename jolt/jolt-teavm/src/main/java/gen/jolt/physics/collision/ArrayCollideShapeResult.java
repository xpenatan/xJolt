...
public class ArrayCollideShapeResult extends IDLBase {
    ...
    static public final ArrayCollideShapeResult T_01 = new ArrayCollideShapeResult((byte) 1, (char) 1);

    static public final ArrayCollideShapeResult T_02 = new ArrayCollideShapeResult((byte) 1, (char) 1);

    static public final ArrayCollideShapeResult T_03 = new ArrayCollideShapeResult((byte) 1, (char) 1);

    /**
     * Dummy constructor, used internally to creates objects without C++ pointer
     */
    @Deprecated()
    public ArrayCollideShapeResult(byte b, char c) {
    }
    ...
    /*[-TEAVM;-NATIVE]
var jsObj = jolt.wrapPointer(this_addr, jolt.ArrayCollideShapeResult);
jolt.destroy(jsObj);
*/
