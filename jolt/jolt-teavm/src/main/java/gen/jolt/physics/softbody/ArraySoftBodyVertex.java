...
import gen.jolt.SoftBodyVertex;

public class ArraySoftBodyVertex extends IDLBase {

    private SoftBodyVertex SoftBodyVertex_TEMP_GEN_0;

    static public final ArraySoftBodyVertex T_01 = new ArraySoftBodyVertex((byte) 1, (char) 1);

    static public final ArraySoftBodyVertex T_02 = new ArraySoftBodyVertex((byte) 1, (char) 1);

    static public final ArraySoftBodyVertex T_03 = new ArraySoftBodyVertex((byte) 1, (char) 1);

    /**
     * Dummy constructor, used internally to creates objects without C++ pointer
     */
    @Deprecated()
    public ArraySoftBodyVertex(byte b, char c) {
    }
    ...
    /*[-TEAVM;-NATIVE]
var jsObj = jolt.wrapPointer(this_addr, jolt.ArraySoftBodyVertex);
jolt.destroy(jsObj);
*/
